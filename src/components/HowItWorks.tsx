    ...
    <section id="how" className="relative z-[1] py-28" ref={ref}>
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center max-w-5xl mx-auto">
          {/* Left */}
          <div>
            <div className="fade-up inline-flex items-center gap-1.5 bg-primary/[0.12] border border-primary/25 rounded-full px-3.5 py-1 text-xs text-electric font-medium tracking-wider uppercase mb-6">
              ✦ How it works
            </div>
            <h2 className="fade-up font-heading text-[clamp(1.8rem,4vw,2.8rem)] font-bold leading-tight tracking-tight mb-5">
              From content to<br />comprehension<br />in seconds
            </h2>

            <div className="flex flex-col">
              {steps.map((s, i) => (
                <div key={s.num} className={`fade-up fade-up-d${i + 1} flex gap-5 py-8 ${i < steps.length - 1 ? "border-b border-border" : ""}`}>
            ...
            <div className="mt-10 fade-up fade-up-d4">
          ...
          {/* Right visual */}
          <div className="fade-up fade-up-d2 bg-surface border border-primary/20 rounded-2xl p-9 shadow-[0_40px_80px_rgba(0,0,0,0.4)] relative overflow-hidden">
            {/* Pulsing border glow */}
            <div className="absolute inset-0 rounded-2xl border border-primary/30 animate-pulse pointer-events-none" />
            ...
            <div className="relative">
              ...
              <div className="bg-gradient-to-br from-primary/25 to-accent/15 border border-primary/35 rounded-xl p-4 text-center mb-5">
                ...
                <div className="font-heading text-base font-bold">
                  Gemini 2.0 Flash ⚡<span className="animate-blink ml-0.5 text-electric">|</span>
                </div>
              </div>
